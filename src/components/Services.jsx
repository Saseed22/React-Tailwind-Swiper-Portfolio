      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="subtitle">
            ...
            dignissimos dolor inventore voluptates earum repellat iusto eligendi
            magnam vitae adipisci voluptatibus quos.
          </p>
        </div>
        {/* item grid */}
          ...
          {services.map((service, index) => {
            ...
            return (
              <div className="bg-secondary p-6 rounded-2xl" key={index}>
                {/* icon */}
                <div
                  className="text-accent rounded-sm w-12 h-12 flex justify-center
